...
RESULTS_DIR="${TOP_LEVEL_DIR}/results/extended_indicators/linear-svm"
...
COMMON_FLAGS="-s minmax -lb 0 -ub 1 -k linear"
COMMON_SUFFIX=""
  ...
  do
    ...
    do
      ...
      then
        ...
        # south asia with/without sb and cost of 10 and 1000
        ${SCRIPTS_DIR}/run_scikit_svm.py \
          -trs $TRAIN_SIZE -tes $TEST_SIZE -sg $COMMON_FLAGS -c 1 -lc $SA_LABEL_COLUMN \
          -o ${SOUTH_ASIAN_PREDICTIONS_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_1 \
          $SOUTH_ASIAN_INPUT_DATA \
          > ${SOUTH_ASIAN_RESULT_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_1
        
        #${SCRIPTS_DIR}/run_scikit_svm.py \
        #  -trs $TRAIN_SIZE -tes $TEST_SIZE -sg $COMMON_FLAGS -c 1 -lc $SA_LABEL_COLUMN -sb \
        #  -o #  ${SOUTH_ASIAN_PREDICTIONS_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_1.sb \
        #  $SOUTH_ASIAN_INPUT_DATA \
        #  > ${SOUTH_ASIAN_RESULT_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_1.sb
        
        ${SCRIPTS_DIR}/run_scikit_svm.py \
          -trs $TRAIN_SIZE -tes $TEST_SIZE -sg $COMMON_FLAGS -c 10 -lc $SA_LABEL_COLUMN \
          -o ${SOUTH_ASIAN_PREDICTIONS_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_10 \
          $SOUTH_ASIAN_INPUT_DATA \
          > ${SOUTH_ASIAN_RESULT_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_10
        
        #${SCRIPTS_DIR}/run_scikit_svm.py \
        #  -trs $TRAIN_SIZE -tes $TEST_SIZE -sg $COMMON_FLAGS -c 10 -lc $SA_LABEL_COLUMN -sb \
        #  -o ${SOUTH_ASIAN_PREDICTIONS_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_10.sb \
        #  $SOUTH_ASIAN_INPUT_DATA \
        #  > ${SOUTH_ASIAN_RESULT_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_10.sb
        
        # european without sb and cost of 10 and 1000
        ${SCRIPTS_DIR}/run_scikit_svm.py \
          -trs $TRAIN_SIZE -tes $TEST_SIZE -sg $COMMON_FLAGS -c 1 -lc $EU_LABEL_COLUMN \
          -o ${EUROPEAN_PREDICTIONS_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_1 \
          $EUROPEAN_INPUT_DATA \
          > ${EUROPEAN_RESULT_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_1
        
        ${SCRIPTS_DIR}/run_scikit_svm.py \
          -trs $TRAIN_SIZE -tes $TEST_SIZE -sg $COMMON_FLAGS -c 10 -lc $EU_LABEL_COLUMN \
          -o ${EUROPEAN_PREDICTIONS_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_10 \
          $EUROPEAN_INPUT_DATA \
          > ${EUROPEAN_RESULT_PREFIX}.trial_${TRIAL}.trs_${TRAIN_SIZE}.tes_${TEST_SIZE}${COMMON_SUFFIX}.c_10
      fi
    done
  done
done
